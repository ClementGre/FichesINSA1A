...
\begin{tikzpicture}[font=\sffamily]
  ...
  % Group
  \node[above of=H, GroupLabel] (Group1) {1};
  \node[above of=Be, GroupLabel] (Group2) {2};
  \node[above of=Sc, GroupLabel] (Group3) {3};
  \node[above of=Ti, GroupLabel] (Group4) {4};
  \node[above of=V, GroupLabel] (Group5) {5};
  \node[above of=Cr, GroupLabel] (Group6) {6};
  \node[above of=Mn, GroupLabel] (Group7) {7};
  \node[above of=Fe, GroupLabel] (Group8) {8};
  \node[above of=Co, GroupLabel] (Group9) {9};
  \node[above of=Ni, GroupLabel] (Group10) {10};
  \node[above of=Cu, GroupLabel] (Group11) {11};
  \node[above of=Zn, GroupLabel] (Group12) {12};
  \node[above of=B, GroupLabel] (Group13) {13};
  \node[above of=C, GroupLabel] (Group14) {14};
  \node[above of=N, GroupLabel] (Group15) {15};
  \node[above of=O, GroupLabel] (Group16) {16};
  \node[above of=F, GroupLabel] (Group17) {17};
  \node[above of=He, GroupLabel] (Group18) {18};

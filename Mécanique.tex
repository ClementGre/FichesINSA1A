    ...
    \chapter{Introduction à la dynamique}\label{ch:introduction-a-la-dynamique}
        ...
        \section{Les grandeurs cinétiques du point}\label{sec:les-grandeurs-cinetiques-du-point}
            ...
            \twoCol {
                ...
                \subsection{L'énergie cinétique}\label{subsec:l-energie-cinetique}
                ...
                \subsection{La quantité de mouvement}\label{subsec:la-quantite-de-mouvement}
            ...
            \subsection{Le moment cinétique}\label{subsec:le-moment-cinetique}
                ...
                \begin{flalign*}
                    ...
                    &= r \vec{e_r} \wedge m r \dot\theta \vec{e_\theta} \re{ (Exemple rotation d'un tourniquet par force appliquée à son extrémité selon $\vec{e_\theta}$)}&\\

...
\twoCol[63]{
    ...
    \begin{itemize}
        ...
        \item Si $f$ injective, alors $\dim{E} \le \dim{F}$
        \item Si $f$ surjective, alors $\dim{E} \ge \dim{F}$
    ...
    On peut écrire un système appelé représentation analytique de $f$, qui exprime les coordonnés de $f(\vec{u})$ en fonction de combinaisons linéaire des composantes de $\vec{u}$ et des coefficients de $f$.\\

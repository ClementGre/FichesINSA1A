...
\chapter{Forces intermoléculaires}\label{ch:forces-intermoleculaires}
  ...
  \section{Interactions de van der Waals}\label{sec:interactions-de-van-der-waals}
    ...
    \begin{itemize}
      ...
      \item \underline{dipôle induit :} molécules apolaires (nuage électronique attiré par les charges positives d'une molécule polaire voisine).
  ...
  \section{La liaison hydrogène}\label{sec:la-liaison-hydrogene}
    ...
    \begin{itemize}
      \item Atome d'hydrogène lié à un atome très électronégatif $\delta +$ ($F$, $N$ ou $O$).
...
\chapter{Modèle du cristal parfait}\label{ch:modele-du-cristal-parfait}
  ...
  \section{L'architecture du cristal}\label{sec:l'architecture-du-cristal}
    ...
    \subsection{Les sept systèmes cristallins et les 14 réseaux de Bravais}\label{subsec:les-sept-systemes-cristallins-et-les-14-reseaux-de-bravais}
      ...
      Les axes de symétrie du cube sont : $4A_3$, $3A_4$ et $6A_2$.
    }{
      \subsection{Sites interstitials dans un réseau cubique toutes faces centrées}\label{subsec:sites-intersticiels-dans-un-reseau-cubique-toutes-faces-centrees}
      ...
      Les sites tétraédriques se trouvent à une distance égale à $\frac{a\sqrt{3}}{2}$ de chaque sommet du cube. $a$ étant le paramètre de maille.\\
